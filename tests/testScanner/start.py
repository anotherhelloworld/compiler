...
for i in range(0, count):
    ...
    fo = open(testnum + '.out')
    # print(testnum)
    ans = (subprocess.check_output(['/Users/a1/Documents/stuff/c++ stuff/compiler/bin/Debug/Compiler', '-s', '/Users/a1/Documents/stuff/c++ stuff/compiler/tests/testScanner/'
     + testnum + '.in'])).split()
